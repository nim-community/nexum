## Nexum Official Site — Built with Nexum
...
proc WhatIsSection(): auto =
  buildHtml:
    section(class = "container", id = "what-is"):
      h2: "What is Nexum"
      p:
        "Nexum generates fine-grained DOM updates at compile time using Nim's macro system. " &
  ...
  buildHtml:
    html(lang = "en"):
      head:
        ...
        title: "Nexum — Compile-time Reactive Web Framework for Nim"
        meta(name = "description", content = "Nexum generates fine-grained DOM updates at compile time. No virtual DOM. Isomorphic by default.")
        ...
        nav(class = "main-nav"):
          `div`(class = "nav-inner"):
            a(href = "#", class = "nav-brand"):
              ...
              span(class = "nav-brand-text"): "Nexum"
            `div`(class = "nav-links"):
              NavLink("#what-is", "What is Nexum")
